...
<title>Articles - My Reflections</title>
 ...
 <% String url = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath(); %>
	...
	<div id="menu" style="height:30px;margin-right:150px;margin-left:150px;background: #cccccc;;border-style:Solid;border-color:white;border-left-width:0px;border-right-width:0px;">
		...
		<li><a href="#">References</a>
			<ul>
				<li> <a href="getArticle.action?articleName=java"> Java </a> </li>
				<li> <a href="getArticle.action?articleName=j2ee"> J2EE </a> </li>
				<li><a href="#">Frameworks</a>
					<ul>
						<li> <a href="getArticle.action?articleName=struts2"> Struts 2 </a> </li>
						<li> <a href="getArticle.action?articleName=springs"> Springs </a> </li>
						<li> <a href="getArticle.action?articleName=hibernate"> Hibernate </a> </li>
					</ul>
				</li>
	...
	<div id="mainbody" style="height:400px;margin-right:150px;margin-left:150px;background-color:green;border-style:Solid;border-color:white;border-left-width:0px;border-right-width:0px;border-top-width:0px;margin-bottom-width:0px;">
		...
		<div id="content" style="height:370px;width:80%;margin-top:0px;float:left;background-color:white">
			These are the reference materials for the different topics which i have learnt in course of time. 
			The content posted here are collective knowledge of different sources. I will try my best to list all the sources to help understand the topics better.
			...
			<ul>
				...
				<li> <a href="getArticle.action?articleName=springs"> Springs </a> </li>
				<li> <a href="getArticle.action?articleName=hibernate"> Hibernate </a> </li>
				<li> <a href="getArticle.action?articleName="> Hadoop </a> </li>
			</ul>
		</div>
	</div>
